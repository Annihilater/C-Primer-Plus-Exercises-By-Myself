...
int main(void) {
    ...
    if ((fp = fopen("chapter_14/14_18_9/Colossus.dat", "rb")) == NULL) {
        fprintf(stderr, "Could not open file 'chapter_14/14_18_9/Colossus.dat'.\n");
        exit(EXIT_FAILURE);
    }
    ...
    Exit:
    fclose(fp);
    if ((fp = fopen("chapter_14/14_18_9/Colossus.dat", "wb")) == NULL) {
        fprintf(stderr, "Could not open file 'chapter_14/14_18_9/Colossus.dat' for write.\n");
        exit(EXIT_FAILURE);
    }

    if (fwrite(flights, flight_size, FLIGHTS, fp) != FLIGHTS) {
        fprintf(stderr, "Error writing to file 'chapter_14/14_18_9/Colossus.dat'.\n");
    }
